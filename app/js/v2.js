	...
	function runUripV2() {
		$(document).ready(function(){
			...
			/* =================
			 Countdown Timer
			 ====================*/
			$('.countdown-timer').countdown('2026/09/05 15:00:00', function(event) { // DEFINE YOUR DATE HERE
				var $this = $(this).html(event.strftime(''
					+ '<li><span class="time-number">%D</span> <span class="time-name">Dias</span></li>'
					+ '<li><span class="time-number">%H</span> <span class="time-name">Horas</span></li>'
					+ '<li><span class="time-number">%M</span> <span class="time-name">Minutos</span></li>'
					+ '<li><span class="time-number">%S</span> <span class="time-name">Segundos</span></li>'));
			});
